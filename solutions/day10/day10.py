    ...
    for line in input:
        ...
        for c in line:
            if c in matching:
                ...
                if parselist and c == matching[parselist.pop(-1)]:
                    continue
                else:
                    score += points[c]
                    break
...
def pt2(input: str):
    ...
    for line in input:
        ...
        if parselist:
            score = 0
            for c in parselist[::-1]:
                score = score * 5 + points[matching[c]]
